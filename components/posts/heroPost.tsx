      ...
      <section className="bg-mybg-light dark:bg-mybg-dark">
        <div className="container max-w-6xl p-6 mx-auto space-y-2 sm:space-y-12">
          <a rel="noopener noreferrer" href={`/posts/${props.content.fields.slug}`} className=" block max-w-sm gap-3 mx-auto sm:max-w-full group hover:no-underline focus:no-underline lg:grid lg:grid-cols-12">
            <img src={props.content.fields.coverImage.fields.file.url} alt={props.content.fields.title} className="object-cover w-full h-48 rounded sm:h-96 mt-6 lg:col-span-7 dark:bg-mybg-dark" />
