    ...
    <>
      <section className="dark:bg-gray-800 dark:text-gray-100">
        <div className="container max-w-xl p-6 py-6 mx-auto space-y-24 lg:px-8 lg:max-w-7xl">
          <div>
            <h2 className="text-3xl font-bold tracking-tight text-center sm:text-5xl dark:text-gray-50">{street.germanName}</h2>
            <p className="max-w-3xl mx-auto mt-4 text-l text-center dark:text-gray-400">{street.previousNames ?? ""}</p>
          </div>
              ...
              <div className="mt-12 space-y-12">
                <div className="flex">
                  ...
                  <div className="ml-4">
                    ...
                    <p className="mt-2 dark:text-gray-400">{street.district}</p>
                  </div>
                </div>
                <div className="flex">
                  <div className="flex-shrink-0">
                  ...
                  <div className="ml-4">
                    ...
                    <p className="mt-2 dark:text-gray-400">{street.polishNames}</p>
                  </div>
                </div>
              </div>
            </div>
      ...
      <h3 className="p-6 text-2xl font-bold tracking-tight sm:text-3xl dark:text-gray-50">Weitere Bilder</h3>
